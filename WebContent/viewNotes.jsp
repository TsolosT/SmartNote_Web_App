	...
	<ul class="listBox">
		<c:choose>
             <c:when test="${listNoteSize>0}">
            	<c:forEach var="note" items="${listNote}">   
		 		 	 	<li class="listItems">			
							...
							<div id="${note.id}" class="modal gg">
							    <div class="modal-content class="modal-content col-lg-8 col-md-6 col-sm-4" style="margin: 150px 10% 150px 10%;"">
	            ...
	            <c:otherwise>
	            	 <h2 class="nofoundmsg">You don't have any note yet...</h2>
	            	 <p class="nofoundmsgP">Go and make new note now!</p>
